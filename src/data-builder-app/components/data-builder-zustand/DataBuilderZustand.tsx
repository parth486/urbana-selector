...
import { ProductGroupsManagerZustand } from "./ProductGroupsManagerZustand";
import { ProductRangesManagerZustand } from "./ProductRangesManagerZustand";
import { ProductsManagerZustand } from "./ProductsManagerZustand";
import { RelationshipsManagerZustand } from "./RelationshipsManagerZustand";
import { DataPreviewZustand } from "./DataPreviewZustand";
import { useDataBuilderStore } from "../../stores/useDataBuilderStore";

export const DataBuilderZustand: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-semibold text-foreground">Data Management (Zustand)</h2>
