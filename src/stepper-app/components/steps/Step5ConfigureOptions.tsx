...
export const Step5ConfigureOptions: React.FC<Step5Props> = ({ data, options, onOptionsChange }) => {
                  ...
                  <div className="border-b border-default-200 pb-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div className="p-3 border border-default-200 rounded-medium">
                        ...
                        <div className="text-sm text-default-500">Cost-effective, treated for outdoor use, 7-10 year lifespan</div>
                      </div>
                      <div className="p-3 border border-default-200 rounded-medium">
                        <div className="font-medium">Hardwood</div>
                        <div className="text-sm text-default-500">Premium appearance, naturally durable, 15-20 year lifespan</div>
                      </div>
                      <div className="p-3 border border-default-200 rounded-medium">
                        <div className="font-medium">Steel</div>
                        <div className="text-sm text-default-500">Maximum durability, galvanized finish, 25+ year lifespan</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-b border-default-200 pb-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="p-3 border border-default-200 rounded-medium">
                        ...
                        <div className="text-sm text-default-500">Standard metal roofing, multiple colors available, good durability</div>
                      </div>
                      <div className="p-3 border border-default-200 rounded-medium">
                        <div className="font-medium">Ultra Grade</div>
                        <div className="text-sm text-default-500">Premium finish with enhanced UV protection and longer warranty</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="p-3 border border-default-200 rounded-medium">
                        ...
                        <div className="text-sm text-default-500">Partial screen on front side for privacy while maintaining airflow</div>
                      </div>
                      <div className="p-3 border border-default-200 rounded-medium">
                        <div className="font-medium">None</div>
                        <div className="text-sm text-default-500">Open design with maximum visibility and airflow</div>
                      </div>
                    </div>
                  </div>
                </div>
